          ...
          <div class="card card-outline card-primary">
            <div class="card-header">
              ...
              <h3 class="card-title">
                ...
                <input type="text" style="text-align: center" value="<?php echo $contador_de_ventas +1;?>" />
              </h3>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="card card-outline card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                <label for="">Monto a Realizar</label>
                ...
                <div class="row">
                  ...
                  <hr>
                  <div class="form-group">
                    <button id="btn_guardar_venta" class="btn btn-primary btn-block">Completar venta</button>
                      ...
                      <div class="modal-dialog modal-sm">
                          <div class="modal-content">
                              <div class="modal-header" style="background-color: #ffc107; color: black">
                                  <h4 class="modal-title">Nuevo Clientes </h4> 
